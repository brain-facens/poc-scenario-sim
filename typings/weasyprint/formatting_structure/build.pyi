...
def make_box(element_tag, style, content, element) -> BlockBox | FlexBox | GridBox | InlineBlockBox | InlineBox | InlineFlexBox | InlineGridBox | InlineTableBox | TableBox | TableCaptionBox | TableCellBox | TableColumnBox | TableColumnGroupBox | TableRowBox | TableRowGroupBox:
    ...

def element_to_box(element, style_for, get_image_from_uri, base_url, target_collector, counter_style, footnotes, state=...) -> list[Any] | list[BlockBox | FlexBox | GridBox | InlineBlockBox | InlineBox | InlineFlexBox | InlineGridBox | InlineTableBox | TableBox | TableCaptionBox | TableCellBox | TableColumnBox | TableColumnGroupBox | TableRowBox | TableRowGroupBox]:
...
def before_after_to_box(element, pseudo_type, state, style_for, get_image_from_uri, target_collector, counter_style) -> list[Any] | list[BlockBox | FlexBox | GridBox | InlineBlockBox | InlineBox | InlineFlexBox | InlineGridBox | InlineTableBox | TableBox | TableCaptionBox | TableCellBox | TableColumnBox | TableColumnGroupBox | TableRowBox | TableRowGroupBox]:
...
def uppercase(text, lang_code) -> str:
    ...

def lowercase(text, lang_code):
    ...

def capitalize(text, lang_code) -> str:
