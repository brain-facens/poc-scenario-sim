...
def get_image_from_uri(cache, url_fetcher, options, url, forced_mime_type=..., context=..., orientation=...) -> RasterImage | SVGImage | None:
...
def process_color_stops(vector_length, positions, hints, style) -> tuple[list[Any | str], list[float | int]]:
...
def gradient_average_color(colors, positions) -> tinycss2.color4.Color | tinycss2.color5.Color | Literal['currentcolor'] | None:
    """
...
class LinearGradient(Gradient):
    ...
    def layout(self, width, height, style) -> tuple[Literal[1], Literal['solid'], None, list[Any], list[Any], list[Any]] | tuple[Literal[1], Literal['solid'], None, list[Any], list[tinycss2.color4.Color | tinycss2.color5.Color | Any | str | None], list[Any]] | tuple[Literal[1], Literal['linear'], tuple[Any, Any, Any, Any], list[int] | list[Any], list[Any], list[float | int]]:
        ...
...
class RadialGradient(Gradient):
    ...
    def layout(self, width, height, style) -> tuple[Literal[1], Literal['solid'], None, list[Any], list[Any], list[Any]] | tuple[Literal[1], Literal['solid'], None, list[Any], list[tinycss2.color4.Color | tinycss2.color5.Color | Any | str | None], list[Any]] | tuple[float | Any, Literal['radial'], tuple[*tuple[Any, ...], Any] | Any | tuple[Any | Literal[0], ...] | tuple[Any | Literal['auto'], Any, Any | str | int, Any | Literal['auto'], Any, Any | str | int], list[Any] | Any | tuple[Any, *tuple[Any, ...]] | list[int] | list[Any | float], Any | list[tinycss2.color4.Color | tinycss2.color5.Color | Any | str | None] | list[Any], Any | list[Any | int] | list[float | int]]:
        ...
