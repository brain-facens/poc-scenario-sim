...
def color(style, name, values) -> tinycss2.color4.Color | tinycss2.color5.Color | Literal['currentcolor'] | None:
    ...

@register_computer('background-position')
@register_computer('object-position')
def compute_position(style, name, values) -> tuple[tuple[Any, Any | Dimension | Literal['auto', 'content', 'from-font', 0] | None, Any, Any | Dimension | Literal['auto', 'content', 'from-font', 0] | None], ...]:
    """Compute lengths in background-position."""
    ...

@register_computer('transform-origin')
def length_or_percentage_tuple(style, name, values) -> tuple[Any | Dimension | str | int | None, ...]:
...
def length_tuple(style, name, values) -> tuple[Any | Dimension | str | int | None, ...]:
...
def length(style, name, value, font_size=..., pixels_only=...) -> Dimension | Literal['auto', 'content', 'from-font', 0] | None:
...
def bleed(style, name, value) -> Dimension | Literal['auto', 'content', 'from-font', 0] | None:
    ...

@register_computer('letter-spacing')
def pixel_length(style, name, value) -> Dimension | Literal['normal', 'auto', 'content', 'from-font', 0] | None:
    ...

@register_computer('background-size')
def background_size(style, name, values) -> tuple[tuple[Any | Dimension | str | int | None, ...] | str, ...]:
...
def border_width(style, name, value) -> int | Dimension | Literal['auto', 'content', 'from-font'] | None:
...
def border_image_outset(style, name, values) -> tuple[int | float | Any | Dimension | str | None, ...]:
...
def length_pixels_only(style, name, value) -> Dimension | Literal['auto', 'content', 'from-font', 0] | None:
...
def border_radius(style, name, values) -> tuple[Any | Dimension | str | int | None, ...]:
    """Compute the ``border-*-radius`` properties."""
    ...

@register_computer('column-gap')
@register_computer('row-gap')
def gap(style, name, value) -> Dimension | Literal['normal', 'auto', 'content', 'from-font', 0] | None:
...
def font_size(style, name, value) -> str | tuple[()] | tuple[str, ...] | tuple[Any, ...] | tuple[tuple[str, None], ...] | tuple[tuple[str, Dimension, str, Dimension], ...] | tuple[tuple[str, str], ...] | tuple[Dimension, ...] | float | int | tuple[int, ...] | tuple[str | None, ...] | tuple[Dimension | None, ...] | Dimension | None:
...
def line_height(style, name, value) -> tuple[Literal['NUMBER'], Any] | tuple[Literal['PIXELS'], Any | Dimension | Literal['auto', 'content', 'from-font', 0] | None] | Literal['normal']:
...
def tab_size(style, name, value) -> int | Dimension | Literal['auto', 'content', 'from-font'] | None:
...
def vertical_align(style, name, value) -> PendingProperty | Dimension | Literal['baseline', 'middle', 'text-top', 'text-bottom', 'top', 'bottom', 'auto', 'content', 'from-font', 0] | None:
    """Compute the ``vertical-align`` property."""
    ...

@register_computer('word-spacing')
def word_spacing(style, name, value) -> Dimension | Literal[0, 'auto', 'content', 'from-font'] | None:
