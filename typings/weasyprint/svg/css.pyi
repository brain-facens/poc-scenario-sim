...
def find_stylesheets_rules(tree, stylesheet_rules, url, font_config, url_fetcher) -> Generator[Any, Any, None]:
...
def parse_stylesheets(tree, url, font_config, url_fetcher) -> tuple[Matcher, Matcher]:
