...
from .urls import URLFetcher, default_url_fetcher, select_source
...
class HTML:
    ...
    def render(self, font_config=..., counter_style=..., color_profiles=..., **options) -> Document:
    ...
    def write_pdf(self, target=..., zoom=..., finisher=..., font_config=..., counter_style=..., color_profiles=..., **options) -> bytes | None:
...
class CSS:
    ...
    """
    def __init__(self, guess=..., filename=..., url=..., file_obj=..., string=..., encoding=..., base_url=..., url_fetcher=..., _check_mime_type=..., media_type=..., font_config=..., counter_style=..., color_profiles=..., matcher=..., page_rules=..., layers=..., layer=...) -> None:
        ...
