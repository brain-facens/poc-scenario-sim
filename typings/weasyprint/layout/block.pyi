...
def block_level_layout(context, box, bottom_space, skip_stack, containing_block, page_is_empty=..., absolute_boxes=..., fixed_boxes=..., adjoining_margins=..., first_letter_style=..., first_line_style=..., discard=..., max_lines=...) -> tuple[*tuple[Any, ...], None] | tuple[*tuple[Any | BlockReplacedBox | dict[str, str | None] | list[Any] | Literal[False] | None, ...], None]:
    """Lay out the block-level ``box``."""
    ...

def block_level_layout_switch(context, box, bottom_space, skip_stack, containing_block, page_is_empty, absolute_boxes, fixed_boxes, adjoining_margins, first_letter_style, first_line_style, discard, max_lines) -> tuple[*tuple[Any, ...], None] | tuple[*tuple[Any | BlockReplacedBox | dict[str, str | None] | list[Any] | Literal[False] | None, ...], None]:
    """Call the layout function corresponding to the ``box`` type."""
    ...

def block_box_layout(context, box, bottom_space, skip_stack, containing_block, page_is_empty, absolute_boxes, fixed_boxes, adjoining_margins, first_letter_style, first_line_style, discard, max_lines) -> tuple[*tuple[Any, ...], None]:
...
def block_container_layout(context, box, bottom_space, skip_stack, page_is_empty, absolute_boxes, fixed_boxes, adjoining_margins, first_letter_style, first_line_style, discard, max_lines):
    """Set the ``box`` height."""
    ...
...
def find_earlier_page_break(context, children, absolute_boxes, fixed_boxes) -> tuple[Any, dict[int, Any]] | tuple[Any | list[Any | BlockBox | TableBox | TableRowGroupBox], dict[Any, None] | dict[Any, Any]] | None:
