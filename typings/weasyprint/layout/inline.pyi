...
def iter_line_boxes(context, box, position_y, bottom_space, skip_stack, containing_block, absolute_boxes, fixed_boxes, first_letter_style, first_line_style) -> Generator[tuple[Any, Any], Any, None]:
...
def get_next_linebox(context, linebox, position_y, bottom_space, skip_stack, containing_block, absolute_boxes, fixed_boxes, first_letter_style, first_line_style):
...
def split_inline_level(context, box, position_x, max_x, bottom_space, skip_stack, containing_block, absolute_boxes, fixed_boxes, line_placeholders, waiting_floats, line_children, first_letter_style, first_line_style) -> tuple[TextBox | Any | ReplacedBox | None, dict[Any, None] | Any | None, Any | Literal[False], Any | Literal['⺀'] | None, Any | Literal['⺀'] | None, dict[str, int] | Any]:
...
def split_inline_box(context, box, position_x, max_x, bottom_space, skip_stack, containing_block, absolute_boxes, fixed_boxes, line_placeholders, waiting_floats, line_children, first_letter_style, first_line_style):
