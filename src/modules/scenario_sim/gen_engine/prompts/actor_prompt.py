...
Para cada ator, crie seus dados pessoais, seu histórico atual e histórico prévio, suas vestimentas e seu perfil comportamental. Deixe cada ator único e interessante, mantenha o escopo dentro do cenário da simulação enquanto fornece o máximo de detalhes possível para seu histórico atual e prévio deixando ambos com no mínimo 5 linhas.
""".strip()
