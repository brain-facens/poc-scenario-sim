...
de acordo com a história e objetivo providos pelo usuário. Tente envolver apenas os atores e alunos
relevantes para o cenário e inclua um simulador apenas caso seja necessário algum equipamento específico para a simulação.
